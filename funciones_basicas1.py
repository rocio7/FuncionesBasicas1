#1 Estamos defininiendo la variable number_of_food_groups y le estamos enviando el valor 5 dicha funcion por lo que al imprimirlo nos dara un resultado de 5 ya que el return indica el final de la funcion pero tambien el valor que devolverá la funcion.
def number_of_food_groups():
    return 5
print(number_of_food_groups())


#2 Este cóigo nos arrojará un error puesto que funcion number_of_days in a week_silicon_or_triangle_sides no ha sido definida aún.
...
#8 Con este codigo primero se obtendra la impresion dentro de la funcion la variable b=100, luego entrará en el ciclo de la condicional if donde segun sea el caso y cumpla con la condicion, con un "return" se devolvera un valor para esta funcion y el return que se encuentra fuera del if no se tomara en cuenta puesto que previamente ya hubo un return efectuado, que dara un valor de 10 al momento de imprimir la función.
...
#9 Este código devolvera como resultado 7, 14 y 21
...
#10 Este codigo imprimirá como resultado 8
def addition(b,c):
    return b+c
    return 10
print(addition(3,5))
